...
export default function SkillCheckScreen({ onRestart }: SkillCheckScreenProps) {
    ...
    return (
        ...
        >
            ...
            >
                Toggle the inputs and watch the signals flow.
            </motion.p>
            ...
            >
                ...
                <svg viewBox="0 0 400 200" className="w-full h-auto">
                    ...
                    {/* Wires from A */}
                    <motion.path
                        d="M 55 60 L 90 60 L 90 45 L 140 45"
                        stroke={inputA ? '#3B82F6' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                        animate={{ stroke: inputA ? '#3B82F6' : '#CBD5E1' }}
                        transition={{ duration: 0.2 }}
                    />
                    <motion.path
                        d="M 55 60 L 90 60 L 90 125 L 140 125"
                        stroke={inputA ? '#3B82F6' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                    ...
                    {/* Wires from B */}
                    <motion.path
                        d="M 55 155 L 110 155 L 110 65 L 140 65"
                        stroke={inputB ? '#3B82F6' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                        animate={{ stroke: inputB ? '#3B82F6' : '#CBD5E1' }}
                        transition={{ duration: 0.2 }}
                    />
                    <motion.path
                        d="M 55 155 L 110 155 L 110 145 L 140 145"
                        stroke={inputB ? '#3B82F6' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                    ...
                    <motion.path
                        ...
                        fill={sum ? '#6366F1' : '#9CA3AF'}
                        stroke={sum ? '#4F46E5' : '#6B7280'}
                        strokeWidth="2"
                        animate={{ fill: sum ? '#6366F1' : '#9CA3AF' }}
                        transition={{ duration: 0.2 }}
                    />
                    ...
                    <motion.path
                        ...
                        fill={carry ? '#10B981' : '#9CA3AF'}
                        stroke={carry ? '#059669' : '#6B7280'}
                        strokeWidth="2"
                        animate={{ fill: carry ? '#10B981' : '#9CA3AF' }}
                        transition={{ duration: 0.2 }}
                    />
                    ...
                    <motion.path
                        d="M 215 55 L 290 55"
                        stroke={sum ? '#6366F1' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                        animate={{ stroke: sum ? '#6366F1' : '#CBD5E1' }}
                        transition={{ duration: 0.2 }}
                    />
                    <motion.path
                        d="M 215 135 L 290 135"
                        stroke={carry ? '#10B981' : '#CBD5E1'}
                        strokeWidth="3"
                        fill="none"
                        strokeLinecap="round"
                        animate={{ stroke: carry ? '#10B981' : '#CBD5E1' }}
                        transition={{ duration: 0.2 }}
                    />
                    ...
                    <text x="305" y="30" className="fill-indigo-500 text-xs font-medium">Sum</text>
                    ...
                    <text x="300" y="110" className="fill-emerald-500 text-xs font-medium">Carry</text>
                </svg>

                {/* Current calculation */}
                <div className="text-center mt-6 pt-4 border-t border-slate-100">
                    <p className="text-slate-500 text-sm mb-2">Binary addition:</p>
