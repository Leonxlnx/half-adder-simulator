...
export default function AndGateScreen({ onContinue }: AndGateScreenProps) {
    ...
    return (
        ...
        >
            ...
            >
                Select a gate for the carry bit.
            </motion.p>
                ...
                <table className="w-full text-center mb-6">
                    <thead>
                        <tr className="text-slate-400 text-sm">
                            ...
                            <th className="py-2 text-emerald-500 font-semibold">2s</th>
                        </tr>
                    </thead>
                    <tbody>
                        {truthTable.map((row, i) => (
                            <tr key={i} className="font-mono">
                                ...
                                <td className="py-1.5 text-emerald-600 font-semibold">{row.twos}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                {feedback !== 'none' && (
                    ...
                    >
                        {feedback === 'correct'
                            ...
                            : "The output is 1 only in one case."}
                    </motion.p>
                )}
            </motion.div>
